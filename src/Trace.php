...
class Trace
{
    ...
    static public function getCache()
    {
        if(app()->runningUnitTests() || defined('IS_UNITTEST')){
            return new class {
                public function put($key, $value, $ttl = null) { return true; }
     ...
     * @return mixed
     */
    static public function getData($unid)
    {
     ...
     * @return Trace
     */
    static public function addError($data)
    {
        $ob              = self::getOb();
     ...
     * @return Trace
     */
    static public function applyData($name, $data)
    {
        $ob              = self::getOb();
